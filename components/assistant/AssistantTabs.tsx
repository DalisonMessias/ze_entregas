  ...
  return (
    <div className="space-y-2">
      <MobileTabsSelect
        ...
        label="Seção do Assistente"
        className="md:hidden"
      />
      <div className="hidden md:flex w-full gap-2 rounded-2xl border border-white/60 bg-white/80 p-1 shadow-sm backdrop-blur dark:border-gray-800/60 dark:bg-gray-900/80">
        {tabs.map(tab => {
