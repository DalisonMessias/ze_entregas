...
import { Plus, Search, Filter, MoreVertical, Edit2, Trash2, Package, Loader2, Tag, ShoppingBag } from 'lucide-react';
        ...
        <div className="p-4 md:p-8 max-w-7xl mx-auto pb-24 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
                <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400 font-medium">Gerencie o cardápio e estoque da sua loja</p>
                </div>
                <div className="flex gap-3">
                    <Button
                        variant="outline"
                        onClick={() => setIsCategoryModalOpen(true)}
                        className="rounded-2xl px-6 py-4 h-auto font-bold border-2 hover:bg-gray-50 dark:hover:bg-gray-800"
                    >
                    ...
                    <Button
                        ...
                        className="rounded-2xl px-6 py-4 h-auto font-bold shadow-xl shadow-brand-500/20"
                    >
            ...
            <div className="bg-white dark:bg-gray-800 rounded-3xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
                <div className="relative mb-8">
                    ...
                    <input
                        ...
                        className="w-full pl-12 pr-4 py-4 bg-gray-50 dark:bg-gray-900/50 border-none rounded-2xl outline-none focus:ring-2 focus:ring-brand-500 dark:text-white text-lg"
                    />
                </div>
