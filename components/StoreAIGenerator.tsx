...
Analise: "${userMsg}".
    ...
    if (msg.includes('429') || msg.includes('quota')) {
        msg = "<b>IA em Manutenção</b><br>O sistema de inteligência artificial está passando por uma manutenção momentânea para melhorias. Por favor, tente novamente em alguns instantes.";
            }
